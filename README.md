...
- Dracula Theme: A dark color scheme for various applications and environments.
...
```
## 6. Configure Zsh, Oh My Zsh, and Starship:

Copy the dotfiles to the appropriate locations:
```shell
    cp .zshrc ~/.zshrc
